...
<html lang="<?php echo $language; ?>">
  <head>
    ...
    <title><?= htmlspecialchars($langStrings['welcome_back']) ?></title>
    <link
      rel="stylesheet"
    ...
    <main class="page-center">
      <article class="sign-up">
        <h1 class="sign-up__title">
          <?= htmlspecialchars($langStrings['welcome_back']) ?>
        </h1>

        <form
          class="sign-up-form form"
          action="handle_pages/login.php"
          method="post"
        >
          <label
          ...
          <button
            ...
            type="submit"
          >
            <?= htmlspecialchars($langStrings['login']) ?>
          </button>
        </form>
      </article>
    </main>
